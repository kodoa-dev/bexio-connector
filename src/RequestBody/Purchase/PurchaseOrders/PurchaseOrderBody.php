...
namespace Aesislabs\BexioConnector\RequestBody\Purchase\PurchaseOrders;
...
class PurchaseOrderBody extends AbstractBody
{
    use PositionTrait;
     ...
     * @return OrderBody
     */
    public function setTitle(?string $title): PurchaseOrderBody
    {
        $this->title = $title;
        return $this;
    }
     ...
     * @return OrderBody
     */
    public function setContactId(?int $contactId): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setContactSubId(?int $contactSubId): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setUserId(int $userId): PurchaseOrderBody
    {
        $this->userId = $userId;
        return $this;
    }
     ...
     * @return OrderBody
     */
    public function setPrProjectId(?int $prProjectId): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setLogopaperId(int $logopaperId): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setLanguageId(int $languageId): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setBankAccountId(int $bankAccountId): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setCurrencyId(int $currencyId): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setPaymentTypeId(int $paymentTypeId): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setHeader(string $header): PurchaseOrderBody
    {
        $this->header = $header;
        return $this;
    }
     ...
     * @return OrderBody
     */
    public function setFooter(string $footer): PurchaseOrderBody
    {
        $this->footer = $footer;
        return $this;
    }
     ...
     * @return OrderBody
     */
    public function setMwstType(int $mwstType): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setMwstIsNet(bool $mwstIsNet): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setShowPositionTaxes(bool $showPositionTaxes): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setIsValidFrom(DateTime $isValidFrom): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setDeliveryAddressType(int $deliveryAddressType): PurchaseOrderBody
    {
     ...
     * @return OrderBody
     */
    public function setApiReference(?string $apiReference): PurchaseOrderBody
    {
